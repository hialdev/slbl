        ...
        <div class="row">
            ...
            <div data-aos="fade-down" data-aos-delay="400" data-aos-duration="1000" class="col-12 col-md-4 mb-3">
                <a href="{{route('product.show',$product->slug)}}" class="text-decoration-none d-block text-dark">
                    <img src="{{ Voyager::image($product->thumbnail('cropped')) == "" ? Voyager::image($product->thumbnail('cropped')) : Voyager::image($product->image)}}" alt="Product" class="w-100 mb-3" style="aspect-ratio:1/1;object-fit:cover;">
                    <h6>{{$product->title}}</h6>
                </a>
            </div>
            @empty
            ...
            <div data-aos="fade-down" data-aos-delay="0" data-aos-duration="1000" class="col-12 col-md-6 mt-4">
                <div class="owl-carousel owl-theme service-carousel">
                    ...
                    <a href="{{route('service.show',$service->slug)}}" class="bg-white d-block text-decoration-none p-2 rounded-3 text-dark text-center">
                        <img src="{{ Voyager::image($service->thumbnail('cropped')) == "" ? Voyager::image($service->thumbnail('cropped')) : Voyager::image($service->image)}}" alt="{{$service->title}} service image" class="rounded-2 mb-3" style="aspect-ratio:10/7;object-fit:cover;">
                        <h6>{{$service->title}}</h6>
                    </a>
                    @empty
        ...
        <div class="row mt-4">
            ...
            <div data-aos="fade-down" data-aos-delay="300" data-aos-duration="1000" class="col-6 col-lg-4 col-xl-3">
                <a href="{{route('news.show',$new->slug)}}" class="d-block mb-4 text-decoration-none text-dark">
                    <img src="{{ Voyager::image($new->thumbnail('cropped')) == "" ? Voyager::image($new->thumbnail('cropped')) : Voyager::image($new->image)}}" alt="Image Thumbnail {{$new->title}} News" class="w-100 mb-2" style="aspect-ratio:16/9;object-fit:cover;">
