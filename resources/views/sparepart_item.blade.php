        ...
        <div class="row">
            <div class="col-12 mb-4">
                <a href="{{route('sparepart.category',$sparepart->category->slug)}}" class="text-decoration-none text-secondary fw-semibold d-flex flex-wrap align-items-center gap-3">
                    ...
                    <span class="text-danger fw-semibold">Sparepart</span>/ <span class="text-danger fw-semibold">Category Name</span>/ <span class="text-secondary fw-semibold">Lorem ipsum dolor sit amet consectetur adipisicing elit</span>
                </a>
            </div>
            <div class="col-12 col-lg-9">
                ...
                <div class="mb-4">
                    <div class="owl-carousel item-carousel owl-theme">
                        ...
                        <img src="{{Voyager::image($image)}}" alt="Image {{$sparepart->title}} sparepart" class="d-block rounded-4">
                        @empty
                        <img data-aos="fade-down" data-aos-delay="0" data-aos-duration="1000" src="{{Voyager::image($sparepart->image)}}" alt="Img {{$sparepart->title}}" class="rounded-4 d-block w-100 my-3" style="aspect-ratio:1/1">
                        @endforelse
                    </div>
