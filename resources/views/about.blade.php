...
<section>
    <div class="container py-5">
        ...
        <div>
            <img data-aos="fade-down" data-aos-delay="0" data-aos-duration="1000" src="{{Voyager::image(setting('about.image'))}}" alt="Image About {{setting('site.title')}}" class="d-block float-end w-100 my-3 m-lg-4" style="max-width: 40em;aspect-ratio:4/3; object-fit:cover">
