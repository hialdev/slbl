    ...
    <div class="d-flex flex-column gap-2">
        <div data-aos="fade-down" data-aos-delay="50" data-aos-duration="1000" class="flex-column gap-2" id="data-floating" style="display:none;transition: all 0.3s ease-in-out;">
            ...
            <div class="ms-auto">
                <div class="d-flex align-items-center cursor-pointer">
                    ...
                    <a href="{{url('https://wa.me/'.setting('site.whatsapp'))}}" class="text-decoration-none d-inline-flex align-items-center justify-content-center rounded-5 bg-success text-white" style="padding: 0.8em"><span class="iconify fs-2" data-icon="bi:whatsapp"></span></a>
                </div>
            </div>
        ...
        <div class="ms-auto">
            <div class="d-flex align-items-center cursor-pointer" id="open-floating">
                ...
                <div class="rounded-5 d-flex align-items-center justify-content-center bg-dark text-white" style="padding: 0.7em">
